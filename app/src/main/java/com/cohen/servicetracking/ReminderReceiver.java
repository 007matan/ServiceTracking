...
public class ReminderReceiver extends BroadcastReceiver {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "com.cohen.servicetracking.Crashalert";
...
//            context.startActivity(new Intent(context, Activity_Panel.class));
            ...
            if (true) {
                actionToService(context, TapService.START_FOREGROUND_SERVICE);
            }
    ...
    private boolean checkToActivateReminder(Context context) {
        ...
        if (!TapService.isMyServiceRunning(context)) {
    ...
    private void actionToService(Context context, String action) {
        Intent startIntent = new Intent(context, TapService.class);
